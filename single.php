	...
	<?php while(have_posts()){ the_post(); $burl =  get_the_post_thumbnail_url($post->ID);?>
		<div class="product-area divider-bottom ptb-90">
		  ...
		  <ul class="large-product-tab" role="tablist">
			<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="<?php echo $burl;?>" alt="<?php the_title();?>" /></a></li>
			 <?php if(get_field('feature_image_2')){?>
			<li role="presentation"><a href="#1" aria-controls="1" role="tab" data-toggle="tab"><img src="<?php echo get_field('feature_image_2');?>" alt="<?php the_title();?>" /></a></li>
			  <?php } if(get_field('feature_image_3')){?>
			<li role="presentation"><a href="#2" aria-controls="2" role="tab" data-toggle="tab"><img src="<?php echo get_field('feature_image_3');?>" alt="<?php the_title();?>" /></a></li>
			<?php } if(get_field('feature_image_4')){?>
			<li role="presentation"><a href="#3" aria-controls="3" role="tab" data-toggle="tab"><img src="<?php echo get_field('feature_image_4');?>" alt="<?php the_title();?>" /></a></li>
			<?php } if(get_field('feature_image_5')){?>
			<li role="presentation"><a href="#4" aria-controls="4" role="tab" data-toggle="tab"><img src="<?php echo get_field('feature_image_5');?>" alt="<?php the_title();?>" /></a></li>
			<?php } if(get_field('feature_image_6')){?>
			<li role="presentation"><a href="#4" aria-controls="5" role="tab" data-toggle="tab"><img src="<?php echo get_field('feature_image_6');?>" alt="<?php the_title();?>" /></a></li>
			<?php } ?>
		  </ul>

						  <!-- Tab panes -->
						  <div class="tab-content large-img-content">
							<div role="tabpanel" class="tab-pane active" id="home"><a class="popup-link" href="<?php echo $burl;?>"><img src="<?php echo $burl;?>" alt="<?php the_title();?>" /></a></div>
							 <?php if(get_field('feature_image_2')){?>
							<div role="tabpanel" class="tab-pane" id="1"><a class="popup-link" href="<?php echo get_field('feature_image_2');?>"><img src="<?php echo get_field('feature_image_2');?>" alt="<?php the_title();?>" /></a></div>
							 <?php } if(get_field('feature_image_3')){?>
							<div role="tabpanel" class="tab-pane" id="2"><a class="popup-link" href="<?php echo get_field('feature_image_3');?>"><img src="<?php echo get_field('feature_image_3');?>" alt="<?php the_title();?>" /></a></div>
							<?php } if(get_field('feature_image_4')){?>
							<div role="tabpanel" class="tab-pane" id="3"><a class="popup-link" href="<?php echo get_field('feature_image_4');?>"><img src="<?php echo get_field('feature_image_4');?>" alt="<?php the_title();?>" /></a></div>
							<?php } if(get_field('feature_image_5')){?>
							<div role="tabpanel" class="tab-pane" id="4"><a class="popup-link" href="<?php echo get_field('feature_image_5');?>"><img src="<?php echo get_field('feature_image_5');?>" alt="<?php the_title();?>" /></a></div>
							<?php } if(get_field('feature_image_6')){?>
							<div role="tabpanel" class="tab-pane" id="5"><a class="popup-link" href="<?php echo get_field('feature_image_6');?>"><img src="<?php echo get_field('feature_image_6');?>" alt="<?php the_title();?>" /></a></div>
								<?php } ?>
						  </div>
						</div>						
					</div>
...
To get the <strong><?php the_title();?></strong> at your doorstep Email us at <strong><?php echo get_field('email','options')?></strong> or call us directly at <strong><?php echo get_field('phone','options')?></strong> to get your queries processed. Our customer support representative is available 24/7 to assist you.</p>
							</div>
...
echo 'No Specification found';
					...
					<div class="col-md-3 col-xs-12 pt-10">
						...
						<div class="widget">
							...
							<p>We are built on the core values of Customer Centrism, Precision Designs and the Passion to provide Personalized Packaging solutions for all.  </p>
					...
					<div class="col-md-3 col-sm-4 mb-30">
						<div class="product-box">
							...
							<a href="<?php echo the_permalink(); ?>" title="<?php the_title(); ?>">
							 <img src="<?php echo $burl;?>" alt="<?php echo $recent->post_title;?>" />
								...
								<div class="action-box">
								 <img class="hover-image" src="<?php echo $burl2;?>" alt="<?php echo $recent->post_title;?>" />
							...
							<div class="product-content text-center">
								<h3 class="product-title"><a href="<?php echo the_permalink(); ?>" title="<?php the_title(); ?>"><?php echo $recent->post_title;?></a></h3>
...
</style><script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/cloudzoom.js"></script>
